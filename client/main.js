...
async function actualizarCliente(){
  ...
  const clienteActualizado = {
    ...
    apellido: document.getElementById("actualizarApellido").value,
    direccion: document.getElementById("actualizarDireccion").value,
    activo: document.getElementById("actualizarActivo").value
  };
  try{
    const respuesta = await fetch(API_URL + "/" + id, 
    {method: "PUT",
    ...
    document.getElementById("updateResult").textContent = "Cliente actualizado correctamente";
  }catch(error){
    document.getElementById("updateResult").textContent = "Error al actualizar: " + error.message;
  }
}